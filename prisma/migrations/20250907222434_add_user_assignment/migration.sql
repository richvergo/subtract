...
CREATE TABLE "new_ChecklistItem" (
    ...
    CONSTRAINT "ChecklistItem_assignedUserId_fkey" FOREIGN KEY ("assignedUserId") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_ChecklistItem" ("assignee", "dueDate", "id", "monthId", "notes", "owner", "status", "title") SELECT "assignee", "dueDate", "id", "monthId", "notes", "owner", "status", "title" FROM "ChecklistItem";
...
INSERT INTO "new_Task" ("assignee", "checklistItemId", "dueDate", "id", "notes", "status", "title") SELECT "assignee", "checklistItemId", "dueDate", "id", "notes", "status", "title" FROM "Task";
DROP TABLE "Task";
