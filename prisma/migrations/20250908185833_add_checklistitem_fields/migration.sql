/*
  ...
  - You are about to drop the column `assigneeId` on the `ChecklistItem` table. All the data in the column will be lost.
  - You are about to drop the column `createdAt` on the `ChecklistItem` table. All the data in the column will be lost.
  - You are about to drop the column `ownerId` on the `ChecklistItem` table. All the data in the column will be lost.
